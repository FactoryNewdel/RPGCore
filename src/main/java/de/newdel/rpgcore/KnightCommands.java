...
public class KnightCommands implements CommandExecutor {
    ...
    public static boolean canUse(Plugin plugin, Player p, KnightAbility ability) {
        switch (ability) {
            case SWORDDASH: return plugin.getConfig().getInt("players." + p.getName() + ".Knight.Level") >= 5;
            case EASYCRIT: return plugin.getConfig().getInt("players." + p.getName() + ".Knight.Level") >= 10;
            case STUNBLOW: return plugin.getConfig().getInt("players." + p.getName() + ".Knight.Level") >= 20;
            case BLEED: return plugin.getConfig().getInt("players." + p.getName() + ".Knight.Level") >= 50;
